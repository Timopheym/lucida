...
class ImageMatchingServiceConcurrentClient : virtual public ImageMatchingServiceIf {
 public:
  ImageMatchingServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  ImageMatchingServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
 ...
 public:
  ...
  void send_request(std::string& _return, const std::string& img_query);
  int32_t send_send_request(const std::string& img_query);
  void recv_send_request(std::string& _return, const int32_t seqid);
  void ping();
  int32_t send_ping();
